...
/**
 * Hook fixtues for testing of hooks.
 *
...
final class another_serverside_filter_fixture extends \tool_usertours\local\filter\base {
}

final class another_clientside_filter_fixture extends \tool_usertours\local\clientside_filter\clientside_filter {
}
...
final class hook_fixtures {
    public static function example_serverside_hook(
        ...
        $hook->add_filter_classname(\tool_usertours\test\hook\serverside_filter_fixture::class);
        $hook->add_filter_classname(\tool_usertours\test\hook\another_clientside_filter_fixture::class);
    ...
    public static function example_clientside_hook(
        ...
        $hook->add_filter_classname(\tool_usertours\test\hook\clientside_filter_fixture::class);
        $hook->add_filter_classname(\tool_usertours\test\hook\another_serverside_filter_fixture::class);
