...
class api_test extends \advanced_testcase {
     ...
     * @return array
     */
    public static function data_request_creation_provider() {
        return [
     ...
     * @return array
     */
    public static function get_data_requests_provider() {
     ...
     */
    public static function status_provider() {
        return [
     ...
     * @return array
     */
    public static function notify_dpo_provider() {
        return [
     ...
     */
    public static function invalid_effective_contextlevel_provider() {
        return [
            [CONTEXT_COURSECAT],
            [CONTEXT_COURSE],
            [CONTEXT_MODULE],
     ...
     */
    public static function set_context_defaults_provider() {
        $contextlevels = [
            [CONTEXT_COURSECAT],
            [CONTEXT_COURSE],
            [CONTEXT_MODULE],
     ...
     * @return array
     */
    public static function queue_data_request_task_provider() {
        return [
     ...
     */
    public static function automatic_request_approval_setting_provider() {
        return [
            'Data export, not set' => [
