...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_get_policy_version() {
        ...
        $result = \core_external\api::clean_returnvalue(external::get_policy_version_returns(), $result);
    ...
    public function test_get_config_with_site_policy_handler() {
        ...
        $result = \core_external\api::clean_returnvalue(external_mobile::get_config_returns(), $result);
    ...
    public function test_agree_site_policy_with_handler() {
        ...
        $result = \core_external\api::clean_returnvalue(\core_user_external::agree_site_policy_returns(), $result);
