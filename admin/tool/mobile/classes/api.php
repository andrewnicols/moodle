    ...
    public static function get_features_list() {
        ...
        $features = array(
            "$general" => array(
                ...
                'NoDelegate_CoreRating' => new lang_string('ratings', 'core_rating'),
                ...
                'CoreFilterDelegate' => new lang_string('type_filter_plural', 'mod_plugin'),
                'CoreReportBuilderDelegate' => new lang_string('reportbuilder', 'core_reportbuilder'),
                'NoDelegate_CoreUserSupport' => new lang_string('contactsitesupport', 'core_admin'),
                'NoDelegate_GlobalSearch' => new lang_string('globalsearch', 'core_search'),
            ),
            "$mainmenu" => array(
                ...
                '$mmSideMenuDelegate_mmaMessages' => new lang_string('messages', 'core_message'),
                '$mmSideMenuDelegate_mmaNotifications' => new lang_string('notifications', 'core_message'),
                '$mmSideMenuDelegate_mmaCalendar' => new lang_string('calendar', 'core_calendar'),
                'CoreMainMenuDelegate_AddonBlog' => new lang_string('blog', 'core_blog'),
                'CoreMainMenuDelegate_CoreTag' => new lang_string('tags'),
                'CoreMainMenuDelegate_QrReader' => new lang_string('scanqrcode', 'tool_mobile'),
            ),
            "$useraccount" => array(
                '$mmSideMenuDelegate_mmaGrades' => new lang_string('grades', 'core_grades'),
                '$mmSideMenuDelegate_mmaFiles' => new lang_string('files'),
                'CoreUserDelegate_AddonBadges:account' => new lang_string('badges', 'core_badges'),
                'CoreUserDelegate_AddonBlog:account' => new lang_string('blog', 'core_blog'),
            ...
            "$course" => array(
                ...
                '$mmCoursesDelegate_mmaGrades' => new lang_string('grades', 'core_grades'),
                '$mmCoursesDelegate_mmaCompetency' => new lang_string('competencies', 'core_competency'),
                '$mmCoursesDelegate_mmaNotes' => new lang_string('notes', 'core_notes'),
                '$mmCoursesDelegate_mmaCourseCompletion' => new lang_string('coursecompletion', 'core_completion'),
                'NoDelegate_CourseBlocks' => new lang_string('blocks'),
                'CoreCourseOptionsDelegate_AddonBlog' => new lang_string('blog', 'core_blog'),
            ...
            "$participants" => array(
                '$mmUserDelegate_mmaGrades:viewGrades' => new lang_string('grades', 'core_grades'),
                '$mmUserDelegate_mmaCourseCompletion:viewCompletion' => new lang_string('coursecompletion', 'core_completion'),
                '$mmUserDelegate_mmaBadges' => new lang_string('badges', 'core_badges'),
                '$mmUserDelegate_mmaNotes:addNote' => new lang_string('notes', 'core_notes'),
                'CoreUserDelegate_AddonBlog:blogs' => new lang_string('blog', 'core_blog'),
                '$mmUserDelegate_mmaCompetency:learningPlan' => new lang_string('competencies', 'core_competency'),
                '$mmUserDelegate_mmaMessages:sendMessage' => new lang_string('sendmessage', 'core_message'),
