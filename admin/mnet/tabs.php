...
$strmnetservices   = get_string('mnetservices', 'core_mnet');
$strmnetedithost   = get_string('reviewhostdetails', 'core_mnet');
...
if (isset($mnet_peer->id) && $mnet_peer->id > 0) {
    ...
    $tabs[] = new tabobject('mnetprofilefields', 'profilefields.php?hostid=' . $mnet_peer->id, get_string('profilefields', 'core_mnet'), get_string('profilefields', 'core_mnet'), false);
} else {
