...
/**
   ...
   */
const SELECTORS={PLUGIN_FILTERS:"#plugins-overview-panel [data-filterby]",PLUGIN_ROWS:"table#plugins-control-panel tbody tr:not(.plugintypeheader)",PLUGIN_TYPE_ROWS:"table#plugins-control-panel tbody tr.plugintypeheader"}}));
