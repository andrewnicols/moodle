...
foreach ($allfunctions as $f) {
    $finfo = \core_external\api::external_function_info($f);
...
if ($mform->is_cancelled()) {
    ...
    $functioninfo = \core_external\api::external_function_info($function);
    ...
    $params = \core_external\api::validate_parameters($functioninfo->parameters_desc, $params);
