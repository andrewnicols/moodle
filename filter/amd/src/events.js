 ...
 *
 * @constant
 * @property {string} filterContentUpdated An event triggered when page content is updated and must be processed by the
 * filter system.
 *
 ...
 * @returns {CustomEvent}
 * @fires eventTypes.filterContentUpdated
 */
