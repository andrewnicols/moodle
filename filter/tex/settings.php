...
if ($ADMIN->fulltree) {
    ...
    $items[] = new admin_setting_configtext('filter_tex/latexbackground', get_string('backgroundcolour', 'core_admin'), '', '#FFFFFF');
    $items[] = new admin_setting_configtext('filter_tex/density', get_string('density', 'core_admin'), '', '120', PARAM_INT);
