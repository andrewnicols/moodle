...
class moodle_content_writer_test extends advanced_testcase {
     ...
     */
    public static function export_data_provider() {
        return [
            'basic' => [
                (object) [
                    'example' => (object) [
     ...
     * return   array
     */
    public static function export_metadata_provider() {
        return [
            'basic' => [
                'key',
                'value',
     ...
     * @return  array
     */
    public static function export_file_provider() {
        return [
            'basic' => [
                'intro',
                0,
     ...
     * @return  array
     */
    public static function export_user_preference_provider() {
        return [
            'basic' => [
                'core_privacy',
                'onekey',
     ...
     * @return array
     */
    public static function long_filename_provider() {
        return [
     ...
     * @return array
     */
    public static function rewrite_pluginfile_urls_provider() {
        return [
            'nullcontent' => [
                'intro',
                0,
