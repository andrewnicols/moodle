...
class behat_theme_classic_behat_admin extends behat_admin {
    ...
    public function i_set_the_following_administration_settings_values(TableNode $table) {
        ...
        foreach ($data as $label => $value) {
            ...
            // Search by label.
            $this->execute('behat_forms::i_set_the_field_to', [get_string('searchinsettings', 'core_admin'), $label]);
            $this->execute("behat_general::i_click_on_in_the", [get_string('search', 'core_admin'), 'button', '.block_settings', 'css_element']);
