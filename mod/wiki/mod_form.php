...
class mod_wiki_mod_form extends moodleform_mod {
    ...
    protected function definition() {
        ...
        $mform->addHelpButton('wikimode', 'wikimode', 'mod_wiki');
        ...
        $mform->addHelpButton('firstpagetitle', 'firstpagetitle', 'mod_wiki');
        ...
        $mform->addHelpButton('defaultformat', 'defaultformat', 'mod_wiki');

        $mform->addElement('checkbox', 'forceformat', get_string('forceformat', 'mod_wiki'));
        $mform->addHelpButton('forceformat', 'forceformat', 'mod_wiki');
