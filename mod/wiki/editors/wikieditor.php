...
class MoodleQuickForm_wikieditor extends MoodleQuickForm_textarea {
    ...
    private function getButtons() {
        ...
        $wiki_editor['image'] = array('ed_img.gif', get_string('wikiimage', 'mod_wiki'), $imagetag[0], $imagetag[1], get_string('wikiimage', 'mod_wiki'));
        ...
        $wiki_editor['external'] = array('ed_external.gif', get_string('wikiexternalurl', 'mod_wiki'), $tag, "", get_string('wikiexternalurl', 'mod_wiki'));
        ...
        $html .= "<label class='accesshide' for='addtags'>" . get_string('insertimage', 'mod_wiki')  . "</label>";
        $html .= "<select id='addtags' class='custom-select mx-1' " .
                 "onchange=\"insertTags('{$imagetag[0]}', '{$imagetag[1]}', this.value)\">";
        $html .= "<option value='" . s(get_string('wikiimage', 'mod_wiki')) . "'>" . get_string('insertimage', 'mod_wiki') . '</option>';
        ...
        $html .= '</select>';
        $html .= $OUTPUT->help_icon('insertimage', 'mod_wiki');
        $html .= '</div>';
