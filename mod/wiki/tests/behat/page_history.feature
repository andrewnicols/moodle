...
Feature: A history of each wiki page is available
  ...
  Scenario: Wiki page edition history changes list
    ...
    And the following "mod_wiki > pages" exist:
      | wiki           | author   | title      | content        |
      | Test wiki name | teacher1 | First page | First edition  |
      | Test wiki name | student1 | First page | Second edition |
      | Test wiki name | student2 | First page | Third edition  |
    ...
    And I follow "Back"
    And I set the field "comparewith" in the "Student 2" "table_row" to "1"
    And I set the field "compare" in the "Teacher 1" "table_row" to "1"
