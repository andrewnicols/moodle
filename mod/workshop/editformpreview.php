...
$PAGE->navbar->add(get_string('editingassessmentform', 'mod_workshop'), $workshop->editform_url(), navigation_node::TYPE_CUSTOM);
$PAGE->navbar->add(get_string('previewassessmentform', 'mod_workshop'));
...
// output starts here
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('assessmentform', 'mod_workshop'), 3);
$mform->display();
echo $OUTPUT->footer();
