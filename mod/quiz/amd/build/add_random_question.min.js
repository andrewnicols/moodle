define ("mod_quiz/add_random_question",["mod_quiz/add_question_modal_launcher","mod_quiz/modal_add_random_question"],function(AddQuestionModalLauncher,ModalAddRandomQuestion){return{init:function(contextId,category,returnUrl,cmid){let showNewCategory=4<arguments.length&&arguments[4]!==void 0?arguments[4]:!0;AddQuestionModalLauncher.init(ModalAddRandomQuestion.TYPE,".menu [data-action=\"addarandomquestion\"]",contextId,function(triggerElement,modal){modal.setCategory(category);modal.setReturnUrl(returnUrl);modal.setCMID(cmid)},showNewCategory)}}});
