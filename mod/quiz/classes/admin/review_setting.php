...
class review_setting extends \admin_setting {
    ...
    public static function fields() {
        return [
            ...
            'correctness'      => get_string('whethercorrect', 'core_question'),
            'maxmarks'         => get_string('maxmarks', 'mod_quiz'),
            'marks'            => get_string('marks', 'core_question'),
            'specificfeedback' => get_string('specificfeedback', 'core_question'),
            'generalfeedback'  => get_string('generalfeedback', 'core_question'),
            'rightanswer'      => get_string('rightanswer', 'core_question'),
