...
//-------------------------------------------------------------------------------
        ...
        $mform->addHelpButton('limitanswers', 'limitanswers', 'mod_choice');

        $mform->addElement('selectyesno', 'showavailable', get_string('showavailable', 'mod_choice'));
        $mform->addHelpButton('showavailable', 'showavailable', 'mod_choice');
...
//-------------------------------------------------------------------------------
        ...
        $mform->addHelpButton('showpreview', 'showpreview', 'mod_choice');
