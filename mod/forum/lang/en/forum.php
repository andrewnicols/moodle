...
$string['posttomygroupsdefault'] = 'Default setting for \'Post a copy to all groups\'';
$string['posttomygroupsdefault_desc'] = 'Determines the default value for the \'Post a copy to all groups\' option in discussion creation forms (both quick and advanced).';
...
$string['showgroupoptionsinquickdiscussion'] = 'Show group options in quick discussion creation';
$string['showgroupoptionsinquickdiscussion_desc'] = 'When enabled, and the relevant group mode is set, the group options will be displayed in the quick discussion creation form.';
