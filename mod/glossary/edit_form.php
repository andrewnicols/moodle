...
//-------------------------------------------------------------------------------
        ...
        $mform->addHelpButton('aliases', 'aliases', 'mod_glossary');

        $mform->addElement('filemanager', 'attachment_filemanager', get_string('attachment', 'mod_glossary'), null, $attachmentoptions);
        $mform->addHelpButton('attachment_filemanager', 'attachment', 'mod_glossary');
...
//-------------------------------------------------------------------------------
            ...
            $mform->addHelpButton('usedynalink', 'entryusedynalink', 'mod_glossary');
            ...
            $mform->addHelpButton('casesensitive', 'casesensitive', 'mod_glossary');
            ...
            $mform->addHelpButton('fullmatch', 'fullmatch', 'mod_glossary');
