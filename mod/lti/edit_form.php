...
class mod_lti_edit_types_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addHelpButton('lti_typename', 'typename', 'mod_lti');
        ...
        $mform->addHelpButton('lti_toolurl', 'toolurl', 'mod_lti');
        ...
        $mform->addHelpButton('lti_description', 'tooldescription', 'mod_lti');
        if (!$istool) {
        ...
        if (!$istool) {
            ...
            $mform->addHelpButton('lti_ltiversion', 'ltiversion', 'mod_lti');
            ...
            $mform->addHelpButton('lti_resourcekey', 'resourcekey_admin', 'mod_lti');
            ...
            $mform->addHelpButton('lti_password', 'password_admin', 'mod_lti');
            ...
            if (!empty($typeid)) {
                ...
                $mform->addHelpButton('lti_clientid_disabled', 'clientidadmin', 'mod_lti');
            ...
            $mform->addHelpButton('lti_keytype', 'keytype', 'mod_lti');
            ...
            $mform->addHelpButton('lti_publickey', 'publickey', 'mod_lti');
            ...
            $mform->addHelpButton('lti_publickeyset', 'publickeyset', 'mod_lti');
            ...
            $mform->addHelpButton('lti_initiatelogin', 'initiatelogin', 'mod_lti');
            ...
            $mform->addHelpButton('lti_redirectionuris', 'redirectionuris', 'mod_lti');
        ...
        if ($istool) {
            ...
            $mform->addHelpButton('lti_parameters', 'parameter', 'mod_lti');
        ...
        $mform->addHelpButton('lti_customparameters', 'custom', 'mod_lti');
        ...
        if (!empty($this->_customdata->isadmin)) {
            ...
            if (empty($this->_customdata->iscoursetool) || !$this->_customdata->iscoursetool) {
                ...
                $mform->addHelpButton('lti_coursevisible', $stringname, 'mod_lti');
        ...
        $mform->addHelpButton('lti_launchcontainer', 'default_launch_container', 'mod_lti');
        ...
        $mform->addHelpButton('lti_contentitem', 'contentitem_deeplinking', 'mod_lti');
        if ($istool) {
        ...
        $mform->addHelpButton('lti_toolurl_ContentItemSelectionRequest', 'toolurl_contentitemselectionrequest', 'mod_lti');
        ...
        $mform->addHelpButton('lti_icon', 'icon_url', 'mod_lti');
        ...
        $mform->addHelpButton('lti_secureicon', 'secure_icon_url', 'mod_lti');

        // Restrict to course categories.
        if (empty($this->_customdata->iscoursetool) || !$this->_customdata->iscoursetool) {
            $mform->addElement('header', 'coursecategory', get_string('restricttocategory', 'mod_lti'));
            $mform->addHelpButton('coursecategory', 'restricttocategory', 'mod_lti');
        ...
        if (!$istool) {
            ...
            $mform->addHelpButton('lti_sendname', 'share_name_admin', 'mod_lti');
            ...
            $mform->addHelpButton('lti_sendemailaddr', 'share_email_admin', 'mod_lti');
            ...
            $mform->addHelpButton('lti_acceptgrades', 'accept_grades_admin', 'mod_lti');
            ...
            $mform->addHelpButton('lti_forcessl', 'force_ssl', 'mod_lti');
            ...
            if (!empty($this->_customdata->isadmin)) {
                ...
                $mform->addHelpButton('lti_organizationid_default', 'organizationid_default', 'mod_lti');
                ...
                $mform->addHelpButton('lti_organizationid', 'organizationidguid', 'mod_lti');

                $mform->addElement('text', 'lti_organizationurl', get_string('organizationurl', 'mod_lti'));
                $mform->setType('lti_organizationurl', PARAM_URL);
                $mform->addHelpButton('lti_organizationurl', 'organizationurl', 'mod_lti');
            }
        }
