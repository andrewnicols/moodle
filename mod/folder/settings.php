...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('folder/showexpanded',
        get_string('showexpanded', 'mod_folder'),
        get_string('showexpanded_help', 'mod_folder'), 1));

    $settings->add(new admin_setting_configtext('folder/maxsizetodownload',
        get_string('maxsizetodownload', 'mod_folder'),
        get_string('maxsizetodownload_help', 'mod_folder'), '', PARAM_INT));
}
