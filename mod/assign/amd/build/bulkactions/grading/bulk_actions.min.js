define("mod_assign/bulkactions/grading/bulk_actions",["exports","core/bulkactions/bulk_actions","./general_action","./delete","./extend","./message","./setmarkingallocation","./setmarkingworkflowstate","core/templates","core/str"],(function(_exports,_bulk_actions,_general_action,_delete,_extend,_message,_setmarkingallocation,_setmarkingworkflowstate,_templates,_str){function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}
/**
