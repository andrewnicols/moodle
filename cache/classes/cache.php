...
class cache implements loader_interface {
     ...
     * @param loader_interface|data_source_interface $loader The next loader in the chain or the data source if there is one and there
     *      are no other loader_interfaces in the chain.
     */
        ...
        if (!helper::result_found($result)) {
            ...
            if ($this->loader !== false) {
                ...
                if ($requiredversion === self::VERSION_NONE) {
                    ...
                    if (!$this->datasource instanceof data_source_interface_versionable) {
