...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('enrol_flatfile/unenrolaction', get_string('extremovedaction', 'core_enrol'), get_string('extremovedaction_help', 'core_enrol'), ENROL_EXT_REMOVED_SUSPENDNOROLES, $options));
