...
namespace core_cohort\callbacks\output;
    ...
    inplace_editable_interface
{
    ...
    public function execute_inplace_editable(inplace_editable_object $callback): void {
        $value = match ($callback->itemtype) {
            'cohortname' => \core_cohort\output\cohortname::update($callback->itemid, $callback->newvalue),
            'cohortidnumber' => \core_cohort\output\cohortidnumber::update($callback->itemid, $callback->newvalue),
            default => null,
        };
