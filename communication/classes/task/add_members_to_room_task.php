...
/**
 * Handle the task of adding members to the room.
 *
...
class add_members_to_room_task extends adhoc_task {
    ...
    public function execute() {
        ...
        if ($communication->get_provider() !== $data->provider) {
            mtrace("Skipping addition of users to the room because the provider no longer matches the requested provider");
            return;
        }
