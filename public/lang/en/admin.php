...
$string['composernotfound'] = 'Composer dependencies were not found. Please ensure that the "composer install --no-dev --optimize-autoloader" command has been run in the Moodle root directory. If you are not using Composer, please ensure that the vendor directory exists and contains the necessary files.';
$string['composerdeveloperdependenciesinstalled'] = 'Composer Developer dependencies are installed. Please ensure that the "composer install --no-dev --optimize-autoloader" command has been run in the Moodle root directory.';
