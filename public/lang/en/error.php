...
$string['apitokenmissingscopes'] = 'The access token provided lacks the required permissions. {$a}';
...
$string['cannoteditthispreference'] = 'It is not possible to edit this preference. Ensure that it is in the list of editable preferences.';
...
$string['expiredapitoken'] = 'The access token provided has expired.';
...
$string['invalidapitoken'] = 'Invalid API key provided or token has been revoked.';
...
$string['revokedapitoken'] = 'Invalid API key provided or token has been revoked.';
