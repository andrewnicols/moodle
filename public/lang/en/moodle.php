...
$string['oauth2:continueasuser'] = 'You are currently logged in as {$a}';
$string['oauth2:continueasuserinfo'] = 'You are currently logged in as {$a}';
$string['oauth2:grantedscopes'] = 'The following scopes have previously been approved:';
$string['oauth2:scope:read'] = '{$a} - read-only access';
$string['oauth2:scope:write'] = '{$a} - write access';
$string['oauth2:scopesforapproval'] = 'The following scopes have been requested for this token:';
$string['oauth2server:manageclients'] = 'Manage OAuth2 server clients';
$string['oauth2server:clients'] = 'OAuth2 server clients';
$string['oauth2server:createclient'] = 'Create a new OAuth2 client';
$string['oauth2server:editclient'] = 'Edit OAuth2 client';
$string['oauth2server:deleteclient'] = 'Delete OAuth2 client';
$string['oauth2server:deleteconfirm'] = 'Are you sure you want to permanently delete the OAuth2 client "{$a}"? This will remove all secrets, redirect URIs, tokens, and granted scopes. This action cannot be undone.';
$string['oauth2server:revokeconfirm'] = 'Are you sure you want to revoke the OAuth2 client "{$a}"? The client will no longer be able to authenticate.';
$string['oauth2server:clientname'] = 'Client name';
$string['oauth2server:clientdescription'] = 'Description';
$string['oauth2server:clientidentifier'] = 'Client ID';
$string['oauth2server:clientstatus'] = 'Status';
$string['oauth2server:clientstatusactive'] = 'Active';
$string['oauth2server:clientstatusrevoked'] = 'Revoked';
$string['oauth2server:timecreated'] = 'Created';
$string['oauth2server:lastaccessed'] = 'Last accessed';
$string['oauth2server:manage'] = 'Manage';
$string['oauth2server:secrets'] = 'Client secrets';
$string['oauth2server:generatesecret'] = 'Generate new secret';
$string['oauth2server:revokesecret'] = 'Revoke secret';
$string['oauth2server:revokesecretconfirm'] = 'Are you sure you want to revoke this secret? Any applications using this secret will no longer be able to authenticate.';
$string['oauth2server:secretgenerated'] = 'New client secret generated';
$string['oauth2server:secretgeneratedinfo'] = 'This is the only time the secret will be displayed. Copy it now and store it securely.';
$string['oauth2server:secretvalue'] = 'Client secret';
$string['oauth2server:secretcopied'] = 'I have copied the secret';
$string['oauth2server:secretmaxreached'] = 'This client already has the maximum number of active secrets ({$a}). Revoke an existing secret before generating a new one.';
$string['oauth2server:redirecturis'] = 'Redirect URIs';
$string['oauth2server:addredirecturi'] = 'Add redirect URI';
$string['oauth2server:removeredirecturi'] = 'Remove redirect URI';
$string['oauth2server:removeredirecturiconfirm'] = 'Are you sure you want to remove the redirect URI "{$a}"?';
$string['oauth2server:redirecturiinvalid'] = 'The redirect URI is not a valid URL.';
$string['oauth2server:redirecturihttpsrequired'] = 'Non-localhost redirect URIs must use HTTPS.';
$string['oauth2server:revokeclient'] = 'Revoke client';
$string['oauth2server:enableclient'] = 'Enable client';
$string['oauth2server:deletenotrevokedfirst'] = 'A client must be revoked before it can be deleted.';
$string['oauth2server:noclients'] = 'No OAuth2 clients have been created yet.';
$string['oauth2server:actions'] = 'Actions';
$string['ok'] = 'OK';
...
$string['privacy:metadata:oauth2_server_client_access_tokens:owner'] = 'The ID of the user which owns the access token';
$string['privacy:metadata:oauth2_server_client_auth_codes:userid'] = 'The ID of the user which owns the auth code';
