...
$string['user_delete_scope_summary'] = 'Delete any user accounts';
$string['user_read_scope_desc'] = 'Allows site-wide read-only access to any user accounts and related data, including user profile information and user preferences.';
$string['user_read_scope_summary'] = 'View any user accounts';
...
$string['user_update_scope_summary'] = 'Update any user accounts';
