 ...
 */
class temptables {
    /** @var string prefix to be used for all the DB objects */
    protected string $prefix;
    /** @var array simple array of unprefixed 'tablename' => DB, final (prefixed) 'tablename' */
    ...
    public function __construct(
        /** @var ?database circular reference, to be able to use DB facilities here if needed */
     ...
     */
    public function delete_temptable(string $tablename): void {
     ...
     */
    public function get_temptables(): array {
     ...
     * @return string|null DB name of the temp table or null if it isn't a temp table
     */
    public function get_correct_name(string $tablename): ?string {
