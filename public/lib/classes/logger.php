...
class logger {
    ...
    public function __construct() {
        $this->add_handler(new \OpenTelemetry\Contrib\Logs\Monolog\Handler(
    ...
    protected function create_logger_for_channel(string $channel): MonologLogger {
     ...
     */
    public function get_channel(string $channel): LoggerInterface {
