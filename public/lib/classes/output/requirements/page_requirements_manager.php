...
EOF;
    ...
    protected function get_requirejs_static_esm_map(): string {
        ...
        $staticmaps = [
            ...
            'theme_boost/index' => '@moodle/lms/theme_boost/bootstrap',
            'theme_boost/bootstrap' => '@moodle/lms/theme_boost/bootstrap',

            // These are the individual util and dom modules that we want to be able to load directly if needed.
            // They are not currently exported by a standard Bootstrap build.
