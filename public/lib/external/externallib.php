...
class core_external extends external_api {
    ...
    #[\core\attribute\deprecated(\core\external\output\update_inplace_editable::class, since: '5.0', mdl: 'MDL-84507')]
    public static function update_inplace_editable_parameters() {
        return \core\external\output\update_inplace_editable::execute_parameters();
    }

    #[\core\attribute\deprecated(\core\external\output\update_inplace_editable::class, since: '5.0', mdl: 'MDL-84507')]
    public static function update_inplace_editable(...$args) {
        return \core\external\output\update_inplace_editable::execute(...$args);
    }

    #[\core\attribute\deprecated(\core\external\output\update_inplace_editable::class, since: '5.0', mdl: 'MDL-84507')]
    public static function update_inplace_editable_returns() {
        return \core\external\output\update_inplace_editable::execute_returns();
    }
