 ...
 */
function get_string_manager($forcereload = false): \core\string_manager {
    if ($forcereload) {
        // The only way to handle this is to reset the entire container. Yuck.
        \core\di::reset_container();
    }

    return \core\di::get(\core\string_manager::class);
}
