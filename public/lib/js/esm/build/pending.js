var n=class t{#e;static pending(e){M.util.js_pending(e)}static complete(e){M.util.js_complete(e)}constructor(e="pendingPromise"){let i,s;this.#e=t.Promise((o,r)=>{i=o,s=r},e),this.resolve=i,this.reject=s}then(e,i){return this.#e.then(e,i)}catch(e){return this.#e.catch(e)}static Promise(e,i="pendingPromise"){let s=new Promise((o,r)=>{t.pending(i),e(o,r)});return s.then(()=>{t.complete(i)}).catch(()=>{}),s}};export{n as default};
/**
