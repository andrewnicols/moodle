import p from"@moodle/lms/core/config";import{getString as f}from"@moodle/lms/core/stringUtils";import{requireAsync as c}from"@moodle/lms/core/amd";var h=(r,t,s,i,o,e)=>{let n=[];return n.push("Deprecation: "),t?n.push(t):n.push(`${r} has been deprecated`),i!==null&&n.push(` since ${i}`),n.push("."),o&&n.push(` ${o}`),s&&n.push(` Please use ${s} instead.`),e&&n.push(` See ${e} for more information.`),n.join("")},d=(r,t,s,i,o,e)=>{let n=[];if(n.push("<h2>Deprecation</h2>"),t?n.push(`<p>${t}`):n.push(`<p><code>${r}</code> is deprecated`),i!==null&&n.push(` since ${i}`),n.push(".</p>"),o&&n.push(`<p>${o}</p>`),s&&n.push(`<p>Please use <code>${s}</code> instead.</p>`),e){let l=`https://moodle.atlassian.net/browse/${e}`;n.push(`<p>See <a href="${l}" target="_blank" rel="noopener noreferrer">${e}</a> for more information.</p>`)}return n.join("")},m=r=>(p.deprecationignorelist||[]).includes(r),$=()=>!!(p.developerdebug||document.querySelector("body.behat-site"));function b(r,{alternativeNotice:t=null,replacement:s=null,since:i=null,reason:o=null,mdl:e=null,final:n=!1,emit:l=!0}={}){if(s===null&&o===null&&e===null)throw new Error("You must provide at least one of replacement, reason or mdl when marking something as deprecated.");let u=h(r,t,s,i,o,e);if((n||$())&&(n||l&&!m(r))){let a=d(r,t,s,i,o,e);c("core/notification").then(g=>g.alert("Deprecation Warning",a,f("ok")))}if(n)throw new Error(u);console.error(u)}export{b as default};
/**
