define("core/esm",["exports","core/import"],(function(_exports,_import){var obj;
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=void 0,_import=(obj=_import)&&obj.__esModule?obj:{default:obj};const defaultRequested=name=>name.endsWith(":default");var _default={load:function(name,req,onload,config){(0,_import.default)((name=>defaultRequested(name)?name.slice(0,-":default".length):name)(name)).then((function(resolvedValue){defaultRequested(name)?onload(resolvedValue.default):onload(resolvedValue)})).catch((function(error){onload.error(error)}))}};return _exports.default=_default,_exports.default}));
