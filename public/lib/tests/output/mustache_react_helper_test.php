...
<div class="skeleton"></div>',
            ...
            'nested props are preserved' => [
                '{"component":"@moodle/lms/mod_forum/discussion","props":{"user":{"name":"John","role":"admin"}}}',
                ['data-react-component="@moodle/lms/mod_forum/discussion"', '"user":{"name":"John","role":"admin"}'],
                [],
            ],
            ...
            'data and aria attributes are passed through' => [
                '{"component":"@moodle/lms/mod_book/viewer","data-course-id":"123","aria-label":"Dialog","role":"dialog"}',
                ['data-course-id="123"', 'aria-label="Dialog"', 'role="dialog"'],
                [],
            ],
            'complex real-world scenario' => [
                '{
    "component": "@moodle/lms/mod_book/report",
    "props": {
...
<div class="loading-spinner"></div>',
                [
                    'data-react-component="@moodle/lms/mod_book/report"',
                    '"columns":["Name","Email","Role"]',
                    'id="users-table"',
                    'class="table-responsive"',
                    'data-page="1"',
