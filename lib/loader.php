...
/**
 * This file is a serving engine for Moodle JS unsuited to the standard loader.
 *
 * @package    core
...
// URLs will always be in the following format:
// /lib/loader.php/[revision]/[component]/[loadertype]/[path/within/target].
...
[$rev, $component, $type] = explode('/', $slashargument, 3);
$rev  = min_clean_param($rev, 'INT');
$component = min_clean_param($component, 'SAFEPATH');
$type = min_clean_param($type, 'SAFEPATH');
