...
const show = root => {
    ...
    CoreEvents.notifyDrawerShown(root.get(0));
    PubSub.publish(DrawerEvents.DRAWER_SHOWN, root, CoreEvents.eventTypes.drawerShown);
};
...
const hide = root => {
    ...
    CoreEvents.notifyDrawerHidden(root.get(0));
    PubSub.publish(DrawerEvents.DRAWER_HIDDEN, root, CoreEvents.eventTypes.drawerHidden);
};
