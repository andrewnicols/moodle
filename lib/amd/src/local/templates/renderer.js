...
export default class Renderer {
    ...
    async setupIconSystem () {
        ...
        const foo = (await import('core/icon_system_fontawesome')).default;
        window.console.log(foo);
        window.console.log('core/icon_system_fontawesome' === config.iconsystemmodule);
        window.console.log(config.iconsystemmodule);
        window.console.log(config.iconsystemmodule);
        const System = await import('core/icon_system_fontawesome');
        // const System = await import(config.iconsystemmodule);
