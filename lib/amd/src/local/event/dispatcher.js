 ...
 * Event dispatcher.
 *
 * @module     core/local/event/dispatcher
 * @package    core
 ...
 * @param {Bool} options.bubbles Whether to bubble up the DOM
 * @param {Bool} options.cancelable Whether preventDefault() can be called
 * @param {Bool} options.composed Whether the event can bubble across the ShadowDOM bounadry
 * @returns {CustomEvent}
 */
