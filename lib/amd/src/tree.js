...
export default class Tree {
    ...
    /**
     * Setup a core/tree instance for a known selector.
     *
     * @param {String} selector
     * @param {function} [selectCallback=null] Called when the active node is changed.
     * @returns {Tree}
     */
    static initialiseForSelector(selector, selectCallback = null) {
        return new Tree(selector, selectCallback);
    }
