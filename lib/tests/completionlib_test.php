...
class completionlib_test extends advanced_testcase {
     ...
     * @return array[]
     */
    public static function internal_get_state_provider() {
        return [
     ...
     * @return array
     */
    public static function internal_get_state_with_grade_criteria_provider() {
        return [
     ...
     * @return array[]
     */
    public static function get_grade_completion_provider() {
        return [
