 ...
 */
class invalid_parameter_response_test extends \route_testcase {
    public function test_basics(): void {
        $this->assertIsInt(invalid_parameter_response::get_status_code());
        $this->assertEquals(400, invalid_parameter_response::get_status_code());
    }
