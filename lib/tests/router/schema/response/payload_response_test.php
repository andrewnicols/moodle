 ...
 */
class payload_response_test extends \route_testcase {
    ...
    public function test_basics(): void {
        ...
        $this->assertSame($request, $payload->get_request());
        $this->assertSame($response, $payload->get_response());
    }
    ...
    public function test_response_standardisation(): void {
        ...
        $handler = new response_handler(\core\container::get_container());
