 ...
 */
class response_test extends \route_testcase {
    public function test_defaults(): void {
        $response = new response();

        // The default status code is 200.
        $this->assertSame(200, $response->get_statuscode());
    }
    ...
    public function test_basics(): void {
        ...
        // The default status code is 200.
        $this->assertSame(450, $response->get_statuscode());
        ...
        $this->assertObjectHasAttribute('headers', $schema);
        $this->assertArrayHasKey('X-Header', $schema->headers);
        $this->assertObjectHasAttribute('description', $schema->headers['X-Header']);
        $this->assertEquals('This is a nice description about the header', $schema->headers['X-Header']->description);
        $this->assertObjectHasAttribute('schema', $schema->headers['X-Header']);
