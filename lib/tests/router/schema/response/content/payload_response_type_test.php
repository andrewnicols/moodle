 ...
 */
class payload_response_type_test extends \advanced_testcase {
    ...
    public function test_description(): void {
        ...
        foreach ($object->get_supported_content_types() as $contenttypeclass) {
            ...
            $this->assertObjectHasAttribute($encoding, $schema);
            $this->assertObjectNotHasAttribute('$ref', $schema->{$encoding});
        }
    ...
    public function test_no_media_type_instances(): void {
        ...
        $object = new class () extends payload_response_type {
