 ...
 */
class example_test extends \route_testcase {
    public function test_value(): void {
        ...
        $this->assertObjectNotHasAttribute('externalValue', $schema);
    }
    ...
    public function test_externalvalue(): void {
        ...
        $schema = $example->get_openapi_schema(new specification());
        $this->assertObjectNotHasAttribute('value', $schema);
        $this->assertEquals(
    ...
    public function test_referenced_object(): void {
        ...
        $this->assertObjectHasAttribute('value', $schema);

        $reference = $object->get_openapi_schema(new specification());
        $this->assertObjectNotHasAttribute('value', $reference);
