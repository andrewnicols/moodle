...
class rtlcss_test extends basic_testcase {
     ...
     * @return array
     */
    public static function directives_provider() {
        return [
            [[
     ...
     * @return array
     */
    public static function transform_origin_provider() {
        return [
            [[
     ...
     * @return array
     */
    public static function values_nsyntax_provider() {
        return [
            [[
     ...
     * @return array
     */
    public static function values_provider() {
        return [
            [[
