...
class outputrequirementslib_test extends \advanced_testcase {
     ...
     * @see \moodle_url
     */
    public static function js_fix_url_moodle_url_provider() {
        global $CFG;
     ...
     * @see \page_requirements_manager::js_fix_url()
     */
    public static function js_fix_url_plain_string_provider() {
        global $CFG;
        $wwwroot = rtrim($CFG->wwwroot, '/');
        $admin = "/{$CFG->admin}/"; // Deprecated, just for coverage purposes.
     ...
     * @see \page_requirements_manager::js_fix_url()
     */
    public static function js_fix_url_coding_exception_provider() {
        global $CFG;
        $wwwroot = rtrim($CFG->wwwroot, '/');
