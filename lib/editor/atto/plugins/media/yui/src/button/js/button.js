    ...
    TEMPLATES = {
        ...
        TAB_PANES: {
            ...
            VIDEO: '' +
                ...
                '{{{ startToggleableFieldset ' +
                    'elementid=elementid ' +
                    'id="{{elementid}}_video-display-options" ' +
                    'key="displayoptions" ' +
                    'component=component ' +
                '}}}' +
                    '{{renderPartial "form_components.display_options" context=this id=CSS.VIDEO mediatype_video=true}}' +
                '{{{ endToggleableFieldset }}}' +

                '{{{ startToggleableFieldset ' +
                    'elementid=elementid ' +
                    'id="{{elementid}}_video-advanced-settings" ' +
                ...
                '{{{ startToggleableFieldset ' +
                    'elementid=elementid ' +
                    'id="{{elementid}}_video-tracks" ' +
                    'key="tracks" ' +
                    'component=component ' +
                    'extra=helpStrings.tracks ' +
                '}}}' +
            ...
            AUDIO: '' +
                ...
                '{{{ startToggleableFieldset ' +
                    'elementid=elementid ' +
                    'id="{{elementid}}_audio-display-options" ' +
                    'key="displayoptions" ' +
                    'component=component ' +
                '}}}' +
                ...
                '{{{ startToggleableFieldset ' +
                    'elementid=elementid ' +
                    'id="{{elementid}}_audio-advanced-settings" ' +
                    'key="advancedsettings" ' +
                    'component=component ' +
                '}}}' +
