...
/**
   ...
   * @since      3.10.5
   */
const eventTypes={attoButtonHighlightToggled:"editor_atto/attoButtonHighlightToggled"};_exports.eventTypes=eventTypes;_exports.notifyButtonHighlightToggled=(attoButton,buttonName,highlight)=>{const customEvent=new CustomEvent(eventTypes.attoButtonHighlightToggled,{bubbles:!0,cancelable:!1,composed:!1,detail:{buttonName:buttonName,highlight:highlight}});return attoButton.dispatchEvent(customEvent),customEvent}}));
