...
class get_plugins extends external_api {
    ...
    /**
     * Describes the parameters for getting the enabled Tiny Premium plugins.
     *
    ...
    /**
     * External function to get the enabled Tiny Premium plugins.
     *
     * @param int $contextid
     * @return array
     * @since Moodle 4.4
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'premiumplugins' => new external_value(PARAM_TEXT, 'The List of enabled Tiny Premium plugins'),
        ]);
    }
}
