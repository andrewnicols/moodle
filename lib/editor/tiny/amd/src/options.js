...
const directionality = 'moodle:directionality';
...
export const register = (editor, options) => {
    ...
    setOption(directionality, options.directionality);
};
...
export const directionalityPluginsEnabled = (editor) => editor.options.get(directionality);
