...
$legacyclasses = [
    ...
    \admin_category::class => 'adminlib.php',
    \admin_root::class => 'adminlib.php',
    \admin_externalpage::class => 'adminlib.php',
    \admin_settingdependency::class => 'adminlib.php',
    \admin_settingpage::class => 'adminlib.php',
    \admin_setting_flag::class => 'adminlib.php',
    \admin_setting_heading::class => 'adminlib.php',
    \admin_setting_description::class => 'adminlib.php',
    \admin_setting_configtext::class => 'adminlib.php',
    \admin_setting_configtext_with_maxlength::class => 'adminlib.php',
    \admin_setting_configtextarea::class => 'adminlib.php',
    \admin_setting_confightmleditor::class => 'adminlib.php',
    \admin_setting_configpasswordunmask::class => 'adminlib.php',
    \admin_setting_configpasswordunmask_with_advanced::class => 'adminlib.php',
    \admin_setting_encryptedpassword::class => 'adminlib.php',
    \admin_setting_configempty::class => 'adminlib.php',
    \admin_setting_configfile::class => 'adminlib.php',
    \admin_setting_configexecutable::class => 'adminlib.php',
    \admin_setting_configdirectory::class => 'adminlib.php',
    \admin_setting_configcheckbox::class => 'adminlib.php',
    \admin_setting_configmulticheckbox::class => 'adminlib.php',
    \admin_setting_configmulticheckbox2::class => 'adminlib.php',
    \admin_setting_configselect::class => 'adminlib.php',
    \admin_setting_configmultiselect::class => 'adminlib.php',
    \admin_setting_configtime::class => 'adminlib.php',
    \admin_setting_configduration::class => 'adminlib.php',
    \admin_setting_configduration_with_advanced::class => 'adminlib.php',
    \admin_setting_configiplist::class => 'adminlib.php',
    \admin_setting_configmixedhostiplist::class => 'adminlib.php',
    \admin_setting_configportlist::class => 'adminlib.php',
    \admin_setting_users_with_capability::class => 'adminlib.php',
    \admin_setting_special_adminseesall::class => 'adminlib.php',
    \admin_setting_special_selectsetup::class => 'adminlib.php',
    \admin_setting_sitesetselect::class => 'adminlib.php',
    \admin_setting_bloglevel::class => 'adminlib.php',
    \admin_setting_courselist_frontpage::class => 'adminlib.php',
    \admin_setting_sitesetcheckbox::class => 'adminlib.php',
    \admin_setting_sitesettext::class => 'adminlib.php',
    \admin_setting_requiredtext::class => 'adminlib.php',
    \admin_setting_requiredpasswordunmask::class => 'adminlib.php',
    \admin_setting_special_frontpagedesc::class => 'adminlib.php',
    \admin_setting_emoticons::class => 'adminlib.php',
    \admin_setting_langlist::class => 'adminlib.php',
    \admin_setting_countrycodes::class => 'adminlib.php',
    \admin_settings_country_select::class => 'adminlib.php',
    \admin_settings_num_course_sections::class => 'adminlib.php',
    \admin_settings_coursecat_select::class => 'adminlib.php',
    \admin_setting_special_backupdays::class => 'adminlib.php',
    \admin_setting_special_backup_auto_destination::class => 'adminlib.php',
    \admin_setting_special_debug::class => 'adminlib.php',
    \admin_setting_special_calendar_weekend::class => 'adminlib.php',
    \admin_setting_question_behaviour::class => 'adminlib.php',
    \admin_setting_pickroles::class => 'adminlib.php',
    \admin_setting_pickfilters::class => 'adminlib.php',
    \admin_setting_configtext_with_advanced::class => 'adminlib.php',
    \admin_setting_configcheckbox_with_advanced::class => 'adminlib.php',
    \admin_setting_configcheckbox_with_lock::class => 'adminlib.php',
    \admin_setting_configselect_autocomplete::class => 'adminlib.php',
    \admin_setting_configselect_with_advanced::class => 'adminlib.php',
    \admin_setting_configselect_with_lock::class => 'adminlib.php',
    \admin_setting_special_gradebookroles::class => 'adminlib.php',
    \admin_setting_regradingcheckbox::class => 'adminlib.php',
    \admin_setting_special_coursecontact::class => 'adminlib.php',
    \admin_setting_special_gradelimiting::class => 'adminlib.php',
    \admin_setting_special_grademinmaxtouse::class => 'adminlib.php',
    \admin_setting_special_gradeexport::class => 'adminlib.php',
    \admin_setting_special_gradeexportdefault::class => 'adminlib.php',
    \admin_setting_special_gradepointdefault::class => 'adminlib.php',
    \admin_setting_special_gradepointmax::class => 'adminlib.php',
    \admin_setting_gradecat_combo::class => 'adminlib.php',
    \admin_setting_grade_profilereport::class => 'adminlib.php',
    \admin_setting_my_grades_report::class => 'adminlib.php',
    \admin_setting_special_registerauth::class => 'adminlib.php',
    \admin_page_pluginsoverview::class => 'adminlib.php',
    \admin_page_managemods::class => 'adminlib.php',
    \admin_setting_manageenrols::class => 'adminlib.php',
    \admin_page_manageblocks::class => 'adminlib.php',
    \admin_page_managemessageoutputs::class => 'adminlib.php',
    \admin_page_manageqbehaviours::class => 'adminlib.php',
    \admin_page_manageqtypes::class => 'adminlib.php',
    \admin_page_manageportfolios::class => 'adminlib.php',
    \admin_page_managerepositories::class => 'adminlib.php',
    \admin_setting_manageauths::class => 'adminlib.php',
    \admin_setting_manageantiviruses::class => 'adminlib.php',
    \admin_setting_manageformats::class => 'adminlib.php',
    \admin_setting_managecustomfields::class => 'adminlib.php',
    \admin_setting_managedataformats::class => 'adminlib.php',
    \admin_page_managefilters::class => 'adminlib.php',
    \admin_setting_manage_fileconverter_plugins::class => 'adminlib.php',
    \admin_setting_managemediaplayers::class => 'adminlib.php',
    \admin_setting_managecontentbankcontenttypes::class => 'adminlib.php',
    \admin_setting_managerepository::class => 'adminlib.php',
    \admin_setting_enablemobileservice::class => 'adminlib.php',
    \admin_setting_manageexternalservices::class => 'adminlib.php',
    \admin_setting_webservicesoverview::class => 'adminlib.php',
    \admin_setting_managewebserviceprotocols::class => 'adminlib.php',
    \admin_setting_configcolourpicker::class => 'adminlib.php',
    \admin_setting_configstoredfile::class => 'adminlib.php',
    \admin_setting_devicedetectregex::class => 'adminlib.php',
    \admin_setting_configmultiselect_modules::class => 'adminlib.php',
    \admin_setting_php_extension_enabled::class => 'adminlib.php',
    \admin_setting_servertimezone::class => 'adminlib.php',
    \admin_setting_forcetimezone::class => 'adminlib.php',
    \admin_setting_searchsetupinfo::class => 'adminlib.php',
    \admin_setting_scsscode::class => 'adminlib.php',
    \admin_setting_filetypes::class => 'adminlib.php',
    \admin_setting_agedigitalconsentmap::class => 'adminlib.php',
    \admin_settings_sitepolicy_handler_select::class => 'adminlib.php',
    \admin_setting_configthemepreset::class => 'adminlib.php',
    \admin_settings_h5plib_handler_select::class => 'adminlib.php',
    \admin_setting_check::class => 'adminlib.php',
    \admin_setting_savebutton::class => 'adminlib.php',

    \part_of_admin_tree::class => 'adminlib.php',
    \parentable_part_of_admin_tree::class => 'adminlib.php',

    \course_enrolment_manager::class => [
        'core_enrol',
        'locallib.php',
    ],
    \enrol_user_button::class => [
        'core_enrol',
        'locallib.php',
    ],
    \user_enrolment_action::class => [
        'core_enrol',
        'locallib.php',
    ],
    \enrol_ajax_exception::class => [
        'core_enrol',
        'locallib.php',
    ],
    \enrol_bulk_enrolment_operation::class => [
        'core_enrol',
        'locallib.php',
    ],
];
