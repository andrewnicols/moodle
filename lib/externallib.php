...
class_alias(\core_external\files::class, 'external_files');
class_alias(\core_external\warnings::class, 'external_warnings');
class_alias(\core_external\settings::class, 'external_settings');

use core_external\api;
