...
class phpunit_dataset_test extends advanced_testcase {
     ...
     */
    public static function from_file_provider() {
     ...
     */
    public static function from_array_provider() {
        return [
     ...
     */
    public static function load_csv_provider() {
     ...
     */
    public static function load_xml_provider() {
     ...
     */
    public static function to_database_provider() {
     ...
     */
    public static function get_rows_provider() {
