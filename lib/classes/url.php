 ...
 * and / or to process form data. A \core\url object :
...
class url {
    ...
    /**
     * Create new instance of \core\url..
     *
     * @param self|string $url - \core\url means make a copy of another
     *      \core\url and change parameters, string means full url or shortened
    ...
    /**
     * Compares this \core\url with another.
     *
     * See documentation of constants for an explanation of the comparison flags.
     *
     * @param self $url The \core\url object to compare
