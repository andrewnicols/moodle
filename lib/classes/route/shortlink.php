 ...
 *
 * Short links are a way to create a short URL that redirects to a longer Moodle URL.
 *
 * @package    core
...
class shortlink {
    /**
     * Handle a user-specific Moodle Short Link.
     *
    ...
    /**
     * Global short links do not require login, but the point that they redirect to may.
     *
     * @param \Psr\Http\Message\ServerRequestInterface $request
     * @param \Psr\Http\Message\ResponseInterface $response
     * @param string $shortcode
