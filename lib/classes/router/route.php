...
class route {
    ...
    public function __construct(
        ...
        protected bool $cookies = true,

        /** @var bool Whether to abort after configuration */
        protected bool $abortafterconfig = false,
    ...
    /**
     * Whether the request should be able to access the session or cookies.
     *
     * @return bool
     */
    public function can_access_cookies(): bool {
        return $this->cookies;
    }

    /**
     * Whether the current request should load all of Moodle or should abort after loading basic configuration.
     *
     * @return bool
     */
    public function abort_after_config(): bool {
        return $this->abortafterconfig;
    }
}
