    ...
    mapped_property_parameter
{
    ...
    protected function get_course_for_value(string $value): mixed {
        ...
        throw new \invalid_parameter_exception('Invalid course parameter.');
    }
    ...
    public function add_attributes_for_parameter_value(
        ...
        return $request
            ->withAttribute('course', $course)
            ->withAttribute('coursecontext', \core\context\course::instance($course->id));
    }
}
