...
/**
 * Antivirus feature class.
 *
 * @package    core_feature
 * @copyright  Andrew Lyons <andrew@nicols.co.uk>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class antivirus_feature extends abstract_feature {
    /** @var int Scanning result indicating no virus found. */
    public const SCAN_RESULT_OK = 0;

    /** @var int  Scanning result indicating that virus is found. */
    public const SCAN_RESULT_FOUND = 1;

    /** @var int  Scanning result indicating the error. */
    public const SCAN_RESULT_ERROR = 2;

    /** @var \stdClass the config for antivirus */
    protected \stdClass $config;

    /** @var string scanning notice */
    protected string $scanningnotice = '';
