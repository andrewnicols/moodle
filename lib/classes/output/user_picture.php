...
class user_picture implements renderable {
     ...
     * @param null|array $extrafields extra fields to be included in result (do not include TEXT columns because it would break SELECT DISTINCT in MSSQL and ORACLE)
