...
class shortlink {
    ...
    /**
     * Constructor for the Short Link Manager.
     *
     * @param \moodle_database $db
     */
    public function __construct(
        /** @var \moodle_database The DB handle */
     ...
     *
     * @param bool $isuserspecific Whether the shortcode is user-specific.
    ...
    public function create_shortlink(
        ...
        return \core\router\util::get_path_for_callable(
            [\core\route\shortlink::class, 'handle_shortlink'],
            ['shortcode' => $shortcode],
            [],
        );
    }
    ...
    public function create_shortlink_for_users(
        ...
        // Ensure that none of the user IDs are 0.
    ...
    private function generate_and_store_shortcode(
        ...
        $this->db->insert_records('shortlink', array_map(
    ...
    private function get_unused_shortcode(
        ...
        do {
            ...
            if ($userid === 0) {
                ...
                $existing = $this->db->get_records_select_menu(
                    'shortlink',
                    "(userid = 0 OR userid = :userid) AND shortcode $sql",
                    $params,
                    fields: 'id, shortcode',
                );
            }
    ...
    private function get_shortlink_handler(string $component): shortlink_handler_interface {
        ...
        if (!$handler instanceof shortlink_handler_interface) {
            throw new coding_exception("Shortlink handler for component {$component} does not implement shortlink_handler_interface");
        }
