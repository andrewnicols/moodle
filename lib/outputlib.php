...
class theme_config {
    ...
    public function resolve_image_location($image, $component, $svg = false) {
        ...
        if ($component === 'moodle' or $component === 'core' or empty($component)) {
            ...
            $candidates = [$image];
            if ($type === 'mod') {
                // And for activities handle fallback to the legacy image type to encourage people to update their
                // images to the new mono styled logo.
                if ($image === 'icon') {
