...
use HTML_Common;
use HTML_QuickForm;
use HTML_QuickForm_advcheckbox;
 ...
 */
class quickform extends \HTML_QuickForm_DHTMLRulesTableless {
    ...
    public function __construct($formName, $method, $action, $target = '', $attributes = null, $ajaxformdata = null) {
        ...
        if (is_a($action, moodle_url::class)) {
...
';
    ...
    function _getElNamesRecursive($element) {
        ...
        if (is_a($element, HTML_QuickForm_group::class)) {
            $elsInGroup = $element->getElements();
            $elNames = array();
            foreach ($elsInGroup as $elInGroup) {
                if (is_a($elInGroup, HTML_QuickForm_group::class)) {
        ...
        } else if (is_a($element, HTML_QuickForm_header::class)) {
            return array();
        } else if (is_a($element, HTML_QuickForm_hidden::class)) {
            return array();
        } else if (
