...
class api_test extends \advanced_testcase {
     ...
     *
     * @covers \core_external\api::validate_parameters
     */
    public function test_validate_params(): void {
        ...
        $result = \core_external\api::validate_parameters($description, $params);
     ...
     *
     * @covers \core_external\api::clean_returnvalue
     */
    public function test_clean_returnvalue_return_php_type(): void {
        ...
        $testdata = ['value' => null];
        try {
            $cleanedvalue = \core_external\api::clean_returnvalue($returndesc, $testdata);
    ...
    /**
     * Test \core_external\api::get_context_from_params().
     *
     * @covers \core_external\api::get_context_from_params
     */
    ...
    /**
     * Test \core_external\api::get_context()_from_params parameter validation.
     *
     * @covers \core_external\api::get_context
     */
    ...
    /**
     * Test \core_external\api::external_function_info.
     *
     * @dataProvider all_external_info_provider
     * @covers \core_external\api::external_function_info
     * @param \stdClass $definition
     */
    public function test_all_external_info(\stdClass $definition): void {
        $desc = \core_external\api::external_function_info($definition);
    ...
    /**
     * Test the \core_external\api::call_external_function() function.
     *
     * @covers \core_external\api::call_external_function
     */
    public function test_call_external_function(): void {
        ...
        $result = \core_external\api::call_external_function('core_cohort_get_cohorts', $params);
        ...
        $result = \core_external\api::call_external_function('core_enrol_get_enrolled_users', $params);
    ...
    protected function get_context_from_params() {
        $rc = new \ReflectionClass(\core_external\api::class);
