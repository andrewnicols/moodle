...
class badgeslib_test extends advanced_testcase {
     ...
     */
    public static function badges_create_site_backpack_provider() {
        return [
     ...
     * @return array
     */
    public static function badges_get_site_primary_backpack_provider() {
        return [
     ...
     * @return array
     */
    public static function badgr_open_url_generator() {
        return [
     ...
     * @return array
     */
    public static function badges_external_get_mapping_provider() {
        return [
