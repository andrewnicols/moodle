...
if ($awards == 'cron') {
    echo $OUTPUT->notification(get_string('awardoncron', 'core_badges'), 'notifysuccess');
} else if ($awards != 0) {
    echo $OUTPUT->notification(get_string('numawardstat', 'core_badges', $awards), 'notifysuccess');
}
