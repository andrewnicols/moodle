...
class external_test extends externallib_advanced_testcase {
    ...
    public function test_get_signup_settings() {
        ...
        $result = \core_external\api::clean_returnvalue(auth_email_external::get_signup_settings_returns(), $result);
    ...
    public function test_signup_user() {
        ...
        $result = auth_email_external::signup_user($username, $password, $firstname, $lastname, $email, $city,  $country,
                                                    '', '', $customprofilefields);
        $result = \core_external\api::clean_returnvalue(auth_email_external::signup_user_returns(), $result);
