...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_send_instant_messages() {
        ...
        $this->assertEquals(
            get_string('usercantbemessaged', 'core_message', fullname(\core_user::get_user($message1['touserid']))),
    ...
    public function test_send_instant_messages_long_text() {
        ...
        $sentmessages = external_api::clean_returnvalue(core_message_external::send_instant_messages_returns(), $sentmessages);
        $this->assertEquals(
            get_string('errormessagetoolong', 'core_message'),
            array_pop($sentmessages)['errormessage']
        );
    }
    ...
    public function test_send_instant_messages_blocked_user() {
        ...
        $this->assertEquals(get_string('usercantbemessaged', 'core_message', fullname($user2)), $sentmessage['errormessage']);
