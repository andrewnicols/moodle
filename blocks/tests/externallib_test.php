...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_get_course_blocks() {
        ...
        $result = \core_external\api::clean_returnvalue(core_block_external::get_course_blocks_returns(), $result);
    ...
    public function test_get_dashboard_blocks_default_dashboard() {
        ...
        // We need to execute the return values cleaning process to simulate the web service server.
        $result = \core_external\api::clean_returnvalue(core_block_external::get_dashboard_blocks_returns(), $result);
