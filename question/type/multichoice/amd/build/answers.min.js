...
/**
   ...
   */
const SELECTORS_ANSWER_LABEL="[data-region=answer-label]";_exports.default={init:rootId=>{const root=document.getElementById(rootId);root.querySelectorAll(SELECTORS_ANSWER_LABEL).forEach((answerLabel=>{answerLabel.addEventListener("click",(e=>{const labelId=e.currentTarget.id;root.querySelector(`[aria-labelledby="${labelId}"]`).click()}))}))}};return _exports.default}));
