...
abstract class column_base extends view_component {
     ...
     * @param bool $ignoremissing Whether to ignore if the class does not exist.
     * @return column_base|null An instance of this class.
     */
    public static function from_column_name(view $view, string $columnname, bool $ignoremissing = false): ?column_base {
