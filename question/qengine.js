...
// TODO Remove the scroll manager and deprecation layer in 4.4. MDL-?????.
var loadedPromise = new Promise(function(resolve) {
    require(['core/scroll_manager'], function(ScrollManager) {
        var transitionLayer = {};

        var deprecatedNotice = function(functionName) {
        ...
        transitionLayer.scroll_to_saved_pos = function() {
            deprecatedNotice('scroll_to_saved_pos', 'scrollToSavedPos');
...
if (!M.core_scroll_manager.save_scroll_pos) {
    ...
    M.core_scroll_manager.save_scroll_pos = function(Y, element) {
        callPromisedFunction(M.core_scroll_manager.save_scroll_pos, arguments.slice(1));
    };
    ...
    M.core_scroll_manager.scroll_to_saved_pos = function(Y) {
        callPromisedFunction(M.core_scroll_manager.scroll_to_saved_pos, arguments);
    };
};
