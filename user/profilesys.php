...
$header = "$SITE->fullname: ".get_string('publicprofile')." (".get_string('myprofile', 'core_admin').")";
...
if ($resetall && confirm_sesskey()) {
    ...
    redirect($PAGE->url, get_string('allprofileswerereset', 'core_my'));
}
...
$button = $OUTPUT->single_button($url, get_string('reseteveryonesprofile', 'core_my'));
