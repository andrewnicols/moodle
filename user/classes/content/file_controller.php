 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class file_controller extends component_file_controller {
    ...
    public static function get_fileareas(): array {
        return array_merge([
            'icon' => fileareas\icon::class,
            'private' => fileareas\private_files::class,
            'profile' => fileareas\profile::class,
            'backup' => fileareas\backup::class,
