...
class core_user_external extends \core_external\external_api {
     ...
     * @since Moodle 4.2
     */
    public static function update_user_device_public_key_parameters(): external_function_parameters {
        return new external_function_parameters([
            'uuid' => new external_value(PARAM_RAW, 'the device UUID'),
     ...
     * @since Moodle 4.2
     */
    public static function update_user_device_public_key($uuid, $appid, $publickey): array {
        $params = self::validate_parameters(self::update_user_device_public_key_parameters(),
            [
                'uuid' => $uuid,
                'appid' => $appid,
                'publickey' => $publickey
        ...
        $status = user_update_device_public_key($params['uuid'], $params['appid'], $params['publickey']);
        if (!$status) {
            $warnings[] = [
                'item' => $params['uuid'],
                'warningcode' => 'devicedoesnotexist',
     ...
     * @since Moodle 4.2
     */
    public static function update_user_device_public_key_returns(): external_single_structure {
        return new external_single_structure([
