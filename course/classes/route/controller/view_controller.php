...
class view_controller {
    ...
    /**
     * Redirect to the course index when no attribute is specified.
     */
    #[route(
        path: '/view',
    )]
    public function view_without_params(): void {
        \core\notification::add(
            'No course ID or shortname provided',
            \core\notification::WARNING,
        );
        util::redirect_with_params(
            '/course',
        );
    }
