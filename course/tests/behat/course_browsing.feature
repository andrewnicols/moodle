...
Feature: Restricting access to course lists
  ...
  Background:
    ...
    And the following "permissions" exist:
      ...
      | Authenticated user      | moodle/category:viewcourselist | Prevent    |
      | Guest                   | moodle/category:viewcourselist | Prevent    |
      | Category viewcourselist | moodle/category:viewcourselist | Allow      |
