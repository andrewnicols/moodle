...
class behat_course extends behat_base {
    ...
    public function activity_should_be_hidden($activityname) {
        ...
        if ($this->is_course_editor()) {
            ...
            if ($this->is_editing_on()) {
                ...
                try {
                    $this->find('named_partial', array('link', get_string('show')), false, $activitynode, 0);
                } catch (ElementNotFoundException $e) {
                    $this->find('named_partial', array('link', get_string('makeavailable')), $noshowexception, $activitynode, 0);
                }
            }
    ...
    public function actions_menu_should_have_item($activityname, $menuitem) {
        ...
        $this->find('named_partial', array('link', $menuitem), $notfoundexception, $activitynode, 0);
    }
