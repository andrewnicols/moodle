...
final class inplace_editable_callback_test extends \advanced_testcase {
    public function test_update_using_webservice(): void {
        ...
        $data = update_inplace_editable::execute('format_weeks', 'sectionname', $section->id, 'New section name');
    ...
    public function test_update_using_webservice_without_permission(): void {
        ...
        update_inplace_editable::execute('format_weeks', 'sectionname', $section->id, 'New section name');
    }
    ...
    public function test_update_inplace_editable(): void {
        ...
        \core\di::get(callback_manager::class)->dispatch('format_weeks', $callback);
