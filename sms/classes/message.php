 ...
 *
 * Note: This class is immutable and will likely become readonly in a future release.
 *
 * @package    core_sms
...
class message {
    ...
    /**
     * Update the message with a database id.
     *
    ...
    public function get_region(): ?string {
        ...
        try {
            ...
            // TODO Throw some more Moodle-specific exceptions to avoid tying calling code to libphonenumber.
