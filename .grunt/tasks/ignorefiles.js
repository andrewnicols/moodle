...
module.exports = grunt => {
    ...
    const handler = function() {
        ...
        const stylelintIgnores = [
            '# Generated by "grunt ignorefiles"',
            'jsdoc/styles/*.css',
            'public_html/**/yui/build/*',
            'public_html/theme/boost/style/moodle.css',
            'public_html/theme/classic/style/moodle.css',
            'public_html/admin/tool/componentlibrary/hugo/dist/css/docs.css',
        ].concat(thirdPartyPaths);
