...
module.exports = grunt => {
    ...
    grunt.registerTask('amdtypes', 'Generate AMD type declarations', function() {
        ...
        let srcFiles = [];
        console.log('amdtypes: determining source files to process...');
        ...
        for (const [componentDir, files] of groups) {
            ...
            // componentDir = <root>/public/lib -> componentPath = public/lib
            const componentPath = path.relative(gruntRoot, componentDir);          // public/lib
            const srcDir = path.join(componentDir, 'amd', 'src'); // <root>/public/lib/amd/src
